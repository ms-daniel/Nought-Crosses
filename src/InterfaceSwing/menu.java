...
public class menu extends JPanel {
	...
	public menu() {
		...
		//cria label para por imagem da op��o jogar
		...
		////cria label para por imagem da op��o sair
		...
		playLabel.addMouseListener(new MouseAdapter() {
			//quando o mouse est� emcima da label
			@Override
	...
	/**
	 * esconde op��es de jogar e sair
	 * e mostra op��es de jogar com ia
	 * ou ver ia vs ia
	 */
